  ...
  <div class="container max-w-6xl px-4 sm:px-6 mx-auto">
    <div class="max-w-3xl w-full text-center mx-auto">
      <h2 class="mb-4 text-2xl font-bold">
        Ở Chidori, luôn có <span class="bg-amber-300 px-1"> không gian</span> dành riêng cho bạn
      </h2>
      <p class="sm:text-lg">Giữa chốn thành thị tấp nập, không gian riêng càng trở nên xa xỉ hơn. Chidori không chỉ là
    ...
    <div class="relative lg:flex mt-12 sm:mt-16">
      ...
      <div class="relative lg:w-2/5">
        <h4 class="text-lg sm:text-xl font-bold">Để giữ một góc nhỏ tại Chidori cho riêng bạn...</h4>
        <ul class="p-0 mt-8 sm:mt-16 flex flex-col space-y-12">
          <li class="flex items-start space-x-6 reveal-left" data-reveal>
            ...
            <div>
              ...
              <div class="mt-4 flex flex-row justify-start items-center space-x-4 text-beige-700">
                <img src="{{ asset('assets/images/spaces.svg') }}" class="w-16 sm:w-20 h-20 sm:h-24 text-beige-200"
                  alt="Space Icon">

                <a class="text-sm sm:text-base font-bold underline underline-offset-4 opacity-90 hover:opacity-100"
                  href="#spaces">
          ...
          <li class="flex items-start space-x-6 reveal-left" data-reveal>
            ...
            <div>
              ...
              <p class="mt-2">Dù chỉ để chợp mắt nghỉ trưa một chút, hay trú ẩn cả ngày dài, Chidori đều có combo phù
                hợp cho bạn.</p>
            </div>
          </li>
          <li class="flex items-start space-x-6 reveal-left" data-reveal>
            ...
            <div>
              ...
              <p class="mt-2">Tất cả trà sử dụng tại Chidori (Sencha, Hojicha, Genmaicha) được tuyển chọn và nhập khẩu
          ...
          <li class="flex items-start space-x-6 reveal-left" data-reveal>
            ...
            <div>
              ...
              <p class="mt-2">Áp dụng triết lý Omotenashi Nhật Bản, Chidori cung cấp dịch vụ bằng lòng chân thành, quan
        ...
        <div class="flex justify-center">
          <a target="_blank" class="btn text-white bg-beige-600 hover:bg-beige-700 font-bold mt-20 rounded-full text-xl py-3.5 px-8"
            rel="noopener" href="#">Đặt chỗ trước</a>
        </div>
      </div>
